...
public class UnityAndGeminiV3: MonoBehaviour
{
    ...
    public void SendChat()
    {
        ...
        SendChatMessage(userMessage, reply =>
        {
            if (uiText != null)
                uiText.text = reply;
        });
    ...
    public void SendChatMessage(string newMessage, Action<string> onReply)
    {
        StartCoroutine(SendChatRequestToGemini(newMessage, onReply));
    }

    private IEnumerator SendChatRequestToGemini(string newMessage, Action<string> onReply)
    {
